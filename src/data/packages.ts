...
export const PACKAGES: Package[] = [
  {
    ...
    workflowInfrastructure: {
      ...
      aiIntegrations: 0,
      platformsSupported: ["Professional automation platforms", "Cloud database systems", "Email & calendar integrations"],
      platformCount: 3,
  ...
  },
  {
    ...
    workflowInfrastructure: {
      ...
      aiIntegrations: 1,
      platformsSupported: ["Advanced automation platforms", "Business intelligence tools", "CRM & sales systems", "AI integrations"],
      platformCount: 7,
  ...
  },
  {
    ...
    workflowInfrastructure: {
      ...
      platformsSupported: ["Enterprise automation suite", "Advanced data platforms", "Custom API development", "Full AI ecosystem"],
