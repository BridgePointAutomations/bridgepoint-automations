...
const HeroSection = ({ onOpenBooking }: HeroSectionProps) => {
  return (
    <section id="hero" className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden pt-4 md:pt-16">
      {/* Dynamic Background */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100/50 border border-slate-200 backdrop-blur-md mb-4"
          >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold tracking-tight mb-4 md:mb-6 leading-tight"
          >
          ...
          <motion.p
            ...
            className="text-xl text-slate-600 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed"
          >
          ...
          <motion.div
            ...
            className="mt-8 md:mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-slate-100 pt-6 md:pt-8"
          >
            {[
