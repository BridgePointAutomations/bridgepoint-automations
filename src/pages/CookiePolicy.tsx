            ...
            <div className="max-w-4xl mx-auto prose prose-slate">
              ...
              <Card className="mb-8">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold mb-3 mt-6 text-foreground">Marketing Cookies (Optional)</h3>
                  <p className="text-muted-foreground mb-3">
                    These cookies may be used in the future to deliver personalized advertisements and measure campaign effectiveness.
                  </p>
                  <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                    <li>Currently not in use</li>
                    <li>Will require explicit consent if implemented</li>
                  </ul>
                </CardContent>
              </Card>
